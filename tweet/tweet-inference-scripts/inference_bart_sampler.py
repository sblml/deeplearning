...
ver = [('v1.0', 'max_len=96,bsz=64,lr=3e-5,hidden=1, kernel-style'),
       ('v1.1', '1.0的基础上 bsz=128 EPC=5 加入schduler'),
       ('v1.2', '1.0的基础上 使用去引号的数据'),
       ('v1.3', '1.0的基础上 用按概率选答案'),
       ('v1.4', '1.3的基础上 5epc'),
       ('v1.4。1', '1.3的基础上 5epc bsz=128'),
       ('v1.5', '1.4的基础上 5epc hidden=2'),
       ('v1.5。1', '1.4的基础上 5epc hidden=3'),
       ('v1.5.2', '1.4的基础上 5epc hidden=6'),
       ('v1.6', '1.5.1的基础上 ohem_loss, rate=0.7'),
       ('v1.6。1', '1.5.1的基础上 ohem_loss, rate=0.5'),
       ('v1.7', '1.6的基础上 加入linear schedual warmup=0.05'),
       ('v1.7.1', '1.7的基础上 bsz=128 lr=4e-5'),
       ('v1.8', '1.7的基础上 加一层linear'),
       ('v1.8.1', '1.7的基础上 加一层linear 7epc'),
       ('v1.9', '1.8的基础上 加一层cnn'),
       ('v1.9.1', '1.8的基础上 加二层cnn'),
       ('v1.10', '1.9的基础上 去掉一层linear'),
       ('v1.11', '1.9的基础上 去掉ohem_loss'),
       ('v1.11.1', '1.5.1的基础上 加一层cnn'),
       ('v1.12', '1.5.1的基础上 加入ReduceLROnPlateau epc=8'),
       ('v1.12.1', '1.5.1的基础上 get_linear_schedule_with_warmup warm=0.05 epc=5'),
       ('v1.13', '1.12.1的基础上  加一层cnn和一层linear'),
       ('v1.14', '1.9的基础上 使用train_5folds_space_mod'),
       ('v1.15', '1.9的基础上 freeze 3epc'),
       ('v1.16', '1.9的基础上 lr=2e-5'),
       ('v1.17', '1.5.1的基础上 maxlen=192 '),
       ('v1.18', '1.9的基础上 maxlen=192 '),
       ('v1.19', '1.9的基础上 maxlen=120 '),
       ('v1.20', '1.5.1的基础上 maxlen=120 '),
       ('v1.20.1', '1.5.1的基础上 maxlen=120 torch.backends.cudnn.deterministic = True'),
       ('v1.21', '1.20.1的基础上 get_linear_schedule_with_warmup warm=0.05 epc=5'),
       ('v1.21.1', '1.20.1的基础上 get_cosine_schedule_with_warmup warm=0.05 epc=5'),
       ('v1.22', '1.20.1的基础上 加入梯度裁剪'),
       ('v1.23', '1.20.1的基础上 ohem_loss, rate=0.7'),
       ('v1.24', '1.20.1的基础上 加一层linear'),
       ('v1.25', '1.20.1的基础上 加一层cnn 加一层linear'),
       ('v1.26', '1.20.1的基础上 get_constant_schedule_with_warmup warm=0.05 epc=5'),
       ('v1.27', '1.20.1的基础上 bsz=32'),
       ('v1.28', '1.20.1的基础上 bsz=128'),
       ('v1.29', '1.20.1的基础上 使用4层cnn'),
       ('v1.30', '1.20.1的基础上 使用large'),
       ('v1.31', '1.20.1的基础上 加入1W条pseudo'),
       ('v1.32', '1.20.1的基础上 maxlen=150'),
       ('v1.33', '1.20.1的基础上 cnn-layer的激活函数用leak'),
       ('v1.34', '1.20.1的基础上 8epc 加入ema'),
       ('v1.35', '1.20.1的基础上 加入分类'),
       ('v1.36', '1.20.1的基础上 labelsmooth 0.3'),
       ('v1.36。1', '1.20.1的基础上 labelsmooth 0.05'),
       ('v1.37', '1.20.1的基础上 dropout=0 epc=8'),
       ('v1.38', '1.20.1的基础上 weight-decay=0'),
       ('v1.39', '1.20.1的基础上 用引号数据'),
       ('v1.40', '1.20.1的基础上 用0.717的pseudo'),
       ('v1.41', '1.20.1的基础上 hidden=4'),
       ('v1.42', '1.20.1的基础上 sent140_pseudo_from_test_top5.csv'),
       ('v1.43', '1.20.1的基础上 使用讨论区的loss '),
       ('v1.43.1', '1.20.1的基础上 使用讨论区的loss start:2,1 end:1,2  epc=8'),
       ('v1.43.2', '1.20.1的基础上 使用讨论区的loss start:4,1 end:1,4  epc=8'),
       ('v1.44', '1.20.1的基础上 训练的时候 随机翻转p=0.3'),
       ('v1.45', '1.20.1的基础上 train_5folds_fr_de_ru.csv fr'),
       ('v1.45.1', '1.20.1的基础上 train_5folds_fr_de_ru.csv de'),
       ('v1.46', '1.20.1的基础上 用新的label-smoothing 0.15'),
       ('v1.46.1', '1.20.1的基础上 用新的label-smoothing 0.05'),
       ('v1.47', '1.20.1的基础上 用kernel的distance-loss'),
       ('v1.47。1', '1.20.1的基础上 只用kernel的distance-loss'),
       ('v1.48', '1.20.1的基础上 用large'),
       ('v1.49', '1.20.1的基础上 sent140_pseudo_from_train_top1.csv'),
       ('v1.50', '1.20.1的基础上 deepset-roberta-base-squad2'),
       ('v1.51', '1.20.1的基础上 10fold'),
       ('v1.52', '1.20.1的基础上 只用neutral'),
       ('v1.52。1', '1.20.1的基础上 不用neutral'),
       ('v1.53',
        '1.20.1的基础上 WeightedRandomSampler(df_train.weight.values, num_samples=int(len(df_train)*0.8), replacement=True) 8epc'),
       ('v1.53.1',
        '1.20.1的基础上 WeightedRandomSampler(df_train.weight.values, num_samples=int(len(df_train)*0.7), replacement=True) 8epc'),
       ('v1.53.2',
        '1.20.1的基础上 WeightedRandomSampler(df_train.weight.values, num_samples=int(len(df_train)*0.6), replacement=True) 8epc'),
       ('v1.53.3',
        '1.20.1的基础上 WeightedRandomSampler(df_train.weight.values, num_samples=int(len(df_train)*0.5), replacement=True) 8epc'),
       ('v1.54', 'v1.53.2的基础上 加入sch'),
       ('v1.54.1', 'v1.4的基础上 epc=10'),
       ('v1.54.2', 'v1.4的基础上 epc=12'),
       ('v1.55', 'v1.54.1的基础上 加入ohem=0.7'),
       ('v1.56', 'v1.54.1的基础上 加一层linear'),
       ('v1.57', 'v1.54.1的基础上 bsz=128'),
       ('v1.57。1', 'v1.54.1的基础上 bsz=32'),
       ('v1.58', 'v1.54.1的基础上 加入distloss'),
       ('v1.59', 'v1.54.1的基础上 hidden=2'),
       ('v1.59.1', 'v1.54.1的基础上 hidden=6'),
       ('v1.60', 'v1.54.1的基础上 y用sent140 pretrain的model'),
       ('v1.61', 'v1.54.1的基础上 dropout=0.3'),
       ('v1.62', 'v1.54.1的基础上 y用sent140 pretrain_output_sent140_all/'),
       ('v1.63', 'v1.54.1的基础上 加入梯度裁剪'),
       ('v1.64', 'v1.54.1的基础上 加入swa 15epc'),
       ('v1.65', 'v1.54.1的基础上 用cosine sch'),
       # train_5folds_weight_v1.20.1_v1.54.1.csv
       ('v1.66', 'v1.54.1的基础上 用train_5folds_weight_v1.20.1_v1.54.1.csv的1.54.1_score做weight sample=0.8'),
       ('v1.67', 'v1.54.1的基础上 word-level'),
       ('v1.68', 'v1.54.1的基础上 loss也加上weight'),
       ('v1.69', 'v1.54.1的基础上 lstm-1层'),
       ('v1.69。1', 'v1.54.1的基础上 lstm-1层 tanh'),
       ('v1.69.2', 'v1.54.1的基础上 gru-1层 tanh'),
       ('v1.69.3', 'v1.54.1的基础上 gru-2层 tanh'),
       ('v1.70', 'v1.54.1的基础上 用朴素模型'),
       ('v1.71', 'v1.54.1的基础上 text-rcnn'),
       ('v1.72', 'v1.54.1的基础上 lstm+cnn 15epc'),
       ('v1.73', 'v1.54.1的基础上 从第6个epc开始 bsz+=20'),
       ('v1.73.1', 'v1.54.1的基础上 gru 从第6个epc开始 bsz+=20'),
       ('v1.73.2', 'v1.73.1的基础上 maxlen=140'),
       ('v1.73.3', 'v1.73的基础上 maxlen=140'),
       ('v1.74', 'v1.73.1的基础上 每个epc bsz+10'),
       ('v1.74.1', 'v1.73.1的基础上 从第6个epc开始 bsz+=30'),
       ('v1.74.2', 'v1.73.1的基础上 从第6个epc开始 bsz+=40'),
       ('v1.74.3', 'v1.74.1的基础上 从第7个epc开始 12epc'),
       # sent140_pseudo_from_test_top5.csv
       ('v1.75', 'v1.73.1的基础上 sent140_pseudo_from_test_top5.csv单独一个loader'),
       ('v1.75.1', 'v1.73.1的基础上 sent140_pseudo_from_train_top1_score.csv'),
       ('v1.76', 'v1.74.1的基础上 weight-decay=0.01'),
       ('v1.77', 'v1.74.1的基础上 去掉warmup'),
       ('v1.77.1', 'v1.74.1的基础上 warmup//25'),
       ('v1.78', 'v1.74.1的基础上 sent140_pseudo_from_train_top1_score.csv'),
       ('v1.79', 'v1.74.1的基础上 加入distance-loss'),
       ('v1.79.1', 'v1.74.1的基础上 distance-loss*0.5'),
       ('v1.79.2', 'v1.74.1的基础上 start-loss*2'),
       ('v1.80', 'v1.74.1的基础上 sample=0.7'),
       ('v1.80.1', 'v1.74.1的基础上 sample=0.5'),
       ('v1.81', 'v1.74.1的基础上 加一层linear'),
       ('v1.82', 'hidden=1'),
       ('v1.82.1', 'hidden=4'),
       ('v1.83', 'v1.74.1的基础上 每个fold用对应的模型'),
       ('v1.84', 'v1.74.1的基础上 用cnn模型 seed和fold-seed都+1'),
       ('v1.84.1', 'v1.74.1的基础上 用第三个 seed和fold-seed都+2'),
       ('v1.84.2', 'v1.74.1的基础上 用第四个 seed和fold-seed都+3'),
       ('v1.84.3', 'v1.74.1的基础上 用第5个 seed和fold-seed都+4'),
       ('v1.85', 'v1.74.1的基础上 weight_decay=0.0001'),
('v1.86', 'v1.74.1的基础上 SmoothCrossEntropyLoss(smoothing=0.1)'),
('v1.86.1', 'v1.74.1的基础上 SmoothCrossEntropyLoss(smoothing=0.2)'),
('v1.86.2', 'v1.74.1的基础上 SmoothCrossEntropyLoss(smoothing=0.3)'),
('v1.86.3', 'v1.74.1的基础上 SmoothCrossEntropyLoss(smoothing=0.6)'),
('v1.86.4', 'v1.74.1的基础上 SmoothCrossEntropyLoss(smoothing=0.9)'),
('v1.87', 'v1.74.1的基础上 cosine sch'),
('v1.88', 'v1.74.1的基础上 lr=2e-5'),
('v1.88.1', 'v1.74.1的基础上 lr=4e-5'),
('v1.89', 'v1.74.1的基础上 用shorter数据训练'),
('v1.89.1', 'v1.74.1的基础上 增加bsz的时候开始用shorter数据训练'),
('v1.89.2', 'v1.74.1的基础上 先用shorter数据 增加bsz的时候开始用原始数据训练'),
('v1.89.3', 'v1.74.1的基础上 0.5概率使用shorter数据'),
('v1.90', 'v1.74.1的基础上 用1.74.1的pseudo pseudo的sample-weight=0.7'),
('v1.90.1', 'v1.74.1的基础上 用1.74.1的pseudo pseudo的sample-weight=1.0'),
('v1.91', 'v1.74.1的基础上 warm=50'),
('v1.91.1', 'v1.74.1的基础上 warm=//15'),
('v1.92', 'v1.74.1的基础上 用修改后的weight 1.74.1小于0.2的 score+0.5'),
('v1.93', 'v1.74.1的基础上 hidden= -1 -3 -5'),
('v1.93。1', 'v1.74.1的基础上 hidden= -1 -3 -5 12epc'),
('v1.94', 'v1.74.1的基础上 去掉dropout'),
('v1.94.1', 'v1.74.1的基础上 dropout=0.2'),
('v1.94.2', 'v1.74.1的基础上 dropout=0.3'),
('v1.95', 'v1.74.1的基础上 yong roberta-base'),
('v1.96', 'v1.74.1的基础上 roberta_large_squad2'),
('v1.96.1', 'v1.74.1的基础上 roberta_large_squad2 6层hidden'),
('v1.97', 'v1.74.1的基础上 增加bsz的时候 sampler的比例减小到0.5'),
('v1.97.1', 'v1.74.1的基础上 增加bsz的时候 sampler的比例增加到0.7'),
('v1.98', 'v1.74.1的基础上 swa '),
('v1.99', 'v1.74.1的基础上 LabelSmoothingLoss(config.MAX_LEN, smoothing=0.1) '),
('v1.99.1', 'v1.74.1的基础上 LabelSmoothingLoss(config.MAX_LEN, smoothing=0.2) '),
('v1.100', 'v1.74.1的基础上 把sentiment放前边 '),
('v1.101', 'v1.74.1的基础上 梯度裁剪'),
('v1.102', 'v1.74.1的基础上 ohem 0.7'),
('v1.103', 'v1.74.1的基础上 seed和fold-seed+10'),
('v1.103.1', 'v1.74.1的基础上 seed和fold-seed+20'),
('v1.103.2', 'v1.74.1的基础上 seed和fold-seed+30'),
('v1.103.3', 'v1.74.1的基础上 seed和fold-seed+64'),
('v1.103.4', 'v1.74.1的基础上 seed和fold-seed+54'),
('v1.104', 'v1.74.1的基础上 10fold'),
('v1.105', 'v1.74.1的基础上 12epc 7epc后加bsz patient=4'),
('v1.105.1', 'v1.74.1的基础上 8epc 3epc后加bsz patient=3'),
('v1.106', 'v1.74.1的基础上 20fold'),
('v1.107', 'v1.74.1的基础上 tanh 换relu'),
('v1.107.1', 'v1.74.1的基础上 2层gru'),
('v1.108', 'v1.74.1的基础上 用pooling代替linear'),
('v1.109', 'v1.74.1的基础上 用cnn+gru的model'),
('v1.110', 'v1.74.1的基础上 不一定要star<end'),
('v1.111', 'v1.74.1的基础上 sample no replace'),
('v1.111.1', 'v1.74.1的基础上 sample no replace sample=0.7'),
('v1.111.2', 'v1.74.1的基础上 sample no replace sample=0.8'),
('v1.112', 'v1.74.1的基础上 用pretrain_output_sent140_all'),
('v1.113', 'v1.74.1的基础上 用large sent140_pseudo_from_train_top1_score.csv'),
       ]
...
#     model1.to(device)
#     model1.load_state_dict(torch.load(f"../../bart/bart_large/output//ckpt_v1.0_{i}.bin"))
#     model1.eval()
...
device = torch.device("cuda")
config.BERT_PATH = "../input/tweetbartconf/"
model_config = transformers.BartConfig.from_pretrained("../input/tweetbartconf/")
model_config.output_hidden_states = True
model1 = TweetModelBart(conf=model_config)
model1.to(device)
model1.load_state_dict(torch.load(f"../input/bart-weights/ckpt_v1.1.1_0.bin"))
model1.eval()

model2 = TweetModelBart(conf=model_config)
model2.to(device)
model2.load_state_dict(torch.load(f"../input/bart-weights/ckpt_v1.1.1_1.bin"))
model2.eval()

model3 = TweetModelBart(conf=model_config)
model3.to(device)
model3.load_state_dict(torch.load(f"../input/bart-weights/ckpt_v1.1.1_2.bin"))
model3.eval()

model4 = TweetModelBart(conf=model_config)
model4.to(device)
model4.load_state_dict(torch.load(f"../input/bart-weights/ckpt_v1.1.1_3.bin"))
model4.eval()

model5 = TweetModelBart(conf=model_config)
model5.to(device)
model5.load_state_dict(torch.load(f"../input/bart-weights/ckpt_v1.1.1_4.bin"))
model5.eval()
...
with open(f"bart-char_pred_test_start.pkl", "wb") as fp:   #Pickling
    pickle.dump(char_pref_pred_start, fp)
    
with open(f"bart-char_pred_test_end.pkl", "wb") as fp:   #Pickling
    pickle.dump(char_pref_pred_end, fp)


# df_test['selected_text'] = final_output
# # df_test.to_csv('Sentiment140_filter_v1_pseudo_v1.20.csv', index=False)
# # final_output = df_test.groupby('textID', sort=False)['selected_text'].apply(lambda x: ' '.join(x)).values


# # sample = pd.read_csv('../../input/preivate_sent140_pseudo.csv')
# sample = pd.read_csv("../../input/sample_submission.csv")
# sample.loc[:, 'selected_text'] = final_output
# # 引号
# # sample['selected_text'] = sample['selected_text'].apply(lambda x: x.replace("'", '`'))

# sample.to_csv(f"submission_{ver[-1][0]}.csv", index=False)
# print(sample.head())
